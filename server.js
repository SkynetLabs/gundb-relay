...
var port = process.env.OPENSHIFT_NODEJS_PORT || process.env.VCAP_APP_PORT || process.env.PORT || process.env.GUNDB_PORT || process.argv[2] || 8765;
...
console.log(`SECRET set to ${process.env["SECRET"]}, PORTAL set to ${process.env["PORTAL"]}, DEBUG set to ${process.env["DEBUG"]}, UNTIL set to ${process.env["UNTIL"]}`)
